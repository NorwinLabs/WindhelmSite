...
const CACHE_NAME = 'windhelm-v1.0';
const STATIC_CACHE = 'windhelm-static-v1.0';
const DYNAMIC_CACHE = 'windhelm-dynamic-v1.0';
...
function isImageRequest(url) {
  return /\.(jpg|jpeg|png|gif|webp|svg)$/i.test(url) || url.includes('/images/');
}
